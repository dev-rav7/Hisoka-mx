...
async function handleAntilinkCommand(sock, chatId, userMessage, senderId, isSenderAdmin) {
    try {
        ...
        if (!action) {
            const usage = `\`\`\`🎭 『𝙒𝘼・𝙃𝙄𝙎・𝙑𝟭』 - ANTILINK SETUP 🎭

✨ Active l'antillien de liens malicieux avec :

${prefix}antilink on

⚔️ Définit l'action punitive (supprimer | exclure | avertir) avec :

${prefix}antilink set delete | kick | warn

🚫 Désactive la protection avec :
