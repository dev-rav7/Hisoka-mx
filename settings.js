...
module.exports = {
    ...
    // add your Session Id make sure it starts with Wa~ and is valid
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY 『𝙒𝘼・𝙃𝙄𝙎・𝙑𝟭』 🃏*",
    ...
    MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/tsml0a.jpg",
    // add custom menu and mention reply image url

    ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/481dsf.jpg",
    // add img for alive msg

    LIVE_MSG: process.env.LIVE_MSG || 
`> ʙᴏᴛ ɪs sᴘᴀʀᴋɪɴɢ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴀʟɪᴠᴇ

ᴋᴇᴇᴘ ᴜsɪɴɢ ✦『𝙒𝘼・𝙃𝙄𝙎・𝙑𝟭』✦ by hhhisoka 

*© 『𝙒𝘼・𝙃𝙄𝙎・𝙑𝟭』*

> ɢɪᴛʜᴜʙ : https://github.com/hhhisoka/Wa-his-v1.0`,
    // add alive msg here 

    STICKER_NAME: process.env.STICKER_NAME || "𝕽𝖆𝖛𝖊𝖓",
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ  hhhisoka*",
    ...
    DEV: process.env.DEV || "2250101676111",
...
`*Hᴇʟʟᴏ ᴛʜᴇʀᴇ 『𝙒𝘼・𝙃𝙄𝙎・𝙑𝟭』 ᴄᴏɴɴᴇᴄᴛᴇᴅ! 👋🏻* 
